...
Funct::Funct(int n11,int n22, int mm, int point11)	{		
...
long int Funct::calcPrecisionForM(int& err_exp, int exp_minG, int max_err_exp, std::string c_field,std::string c_energy, std::string c_Z1)	{
...
std::string Funct::getM(std::string c_F, std::string c_energy, std::string c_Z1){
...
long int Funct::calcPrecisionForN(std::string& str_N, std::string& str_derN,std::string c_F, std::string c_energy, std::string c_Z2)	{
...
long int Funct::getN(std::string& str_N, std::string& str_der_N,std::string c_F, std::string c_energy, std::string c_Z2)	{
...
long int Funct::get_a(std::string& str_a, std::string& str_der_a,std::string c_F, std::string c_energy, std::string c_Z2){
...
long int Funct::get_b(std::string& str_b, std::string& str_der_b,std::string c_F, std::string c_energy, std::string c_Z2){
...
std::string Funct::getB(std::string c_F,std::string c_energy, std::string c_Z2){
